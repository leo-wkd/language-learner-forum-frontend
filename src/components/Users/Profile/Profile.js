...
import { unfollowUserAction, followUserAction, userProfileAction } from "../../../redux/slices/users/usersSlices";
...
export default function Profile({
  ...
  const { userAuth, profile, profileLoading, profileAppErr, profileServerErr, followed, unFollowed } = users;
                          ...
                          <div className="mt-6 sm:flex-1 sm:min-w-0 sm:flex sm:items-center sm:justify-end sm:space-x-6 sm:pb-1">
                            ...
                            <div className="mt-6 flex flex-col justify-stretch space-y-3 sm:flex-row sm:space-y-0 sm:space-x-4">
                              ...
                              {!isLoginUser && <button
                                ...
                                className="inline-flex justify-center bg-indigo-900 px-4 py-2 border border-yellow-700 shadow-sm text-sm font-medium rounded-md text-gray-700  hover:bg-yellow-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500"
                              >
                                <MailIcon
                    ...
                    <div className="flex justify-center place-items-start flex-wrap  md:mb-0">
                      <div className="w-full md:w-1/3 px-4 mb-4 md:mb-0">
                        ...
                        <ul className="">
                          ...
                          <h1 className="text-center text-xl text-gray-800">No Viewer, Keep Writing!</h1>
