          ...
          <div className="w-full flex lg:w-4/12 px-4  mb-6 lg:mb-0">
            ...
            {user?.user?.isBlocked ? (
              <button
                ...
                className="inline-block py-1 px-2 text-center bg-gray-500 text-orange-500 mr-2 mb-1 lg:mb-0 text-xs border rounded"
              >
                Danger
              </button>
            ) : (
              <button
                ...
                className="inline-block py-1 px-2 text-center bg-gray-500 text-green-500 mr-2 mb-1 lg:mb-0 text-xs border rounded"
              >
                Normal
              </button>
            )}
